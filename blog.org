...
** Emacs native-comp on CentOS 7                                      :emacs:
   ...
   nice speedup for [[https://emacs-helm.github.io/helm/][Helm]] completions and a smoother [[https://emacs-lsp.github.io/lsp-ui/][lsp-ui]] experience.
...
*** Deferred and asynchronous compilation
    ...
    Lisp code that we don't often use, or if it takes /forever/ to
