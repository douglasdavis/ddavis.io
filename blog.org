...
** New Toy: ox-hugo                                                    :hugo:
   ...
   stays that way for a while. It can be found [[https://github.com/douglasdavis/dot-emacs][right here]] (you'll see
...
** Introducing pygram11                                :python:numpy:cpp:hep:
   ...
   pygram11 (see my [[https://ddavis.io/posts/numpy-histograms/][NumPy Histogram tricks for HEP]] post).
...
*** In action
    ...
    some [[https://pygram11.readthedocs.io/en/stable/bench.html][benchmarks]] to see how the =omp= argument can speed up the
    calculations.
...
*** pyvenv
    ...
    [[https://github.com/jorgenschaefer/pyvenv][pyvenv]]. Since the =pyenv= installer puts itself in your home
...
*** lsp-mode
    ...
    to use [[https://github.com/palantir/python-language-server][pyls]].
