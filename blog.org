...
[fn:1] when you have to compile extension modules, builds.sr.ht jobs
    might not be the best choice for wheels. The [[https://github.com/joerick/cibuildwheel][=cibuildwheel=]]
    package is worth reading about.
